    ...
    <AnimatePresence>
      <Frame
        ...
        <Stack
          ...
          animate="show"
          >
          <Frame variants={item} background="black" width={1200} height={70} radius="5%" style={{color:'white', fontSize:70}}><span>The <span style={{color:'#fe8c00'}}>super powers</span> I got.</span></Frame>
        </Stack>
