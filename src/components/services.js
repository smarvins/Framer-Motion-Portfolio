    ...
    <AnimatePresence>
      <Frame
        ...
        <Stack
          ...
          animate="show"
          >
          <Frame variants={item} background="black" width={1200} height={70} radius="5%" style={{color:'white', fontSize:70}}><span>These are the <span style={{color:'#7F00FF'}}>cool</span> stuff I can do for <span style={{color:'#7F00FF', fontStyle: 'italic'}}>you</span>.</span></Frame>
        </Stack>
